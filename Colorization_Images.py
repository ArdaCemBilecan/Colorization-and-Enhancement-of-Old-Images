...
# This train is for coloring with pix2pix
# Input images should be colorful images. Class will convert to black- white images for Pix2pix.
class Pix2Pix:

    def __init__(self,input_img_path,test_img_path, output_img_path, model_save_path,loss_object,epoch):
...
input_img_path = 'your_path'
test_img_path = 'your_path'
output = 'your_path'
model_save = 'your_path'
loss_object = tf.keras.losses.BinaryCrossentropy(from_logits=True)
pix2pix = Pix2Pix(input_img_path,test_img_path,output,model_save,loss_object,5)
pix2pix.fit()
